...
2.  **Flyt jeres HTML-formular til EJS:**  
    \- Tag jeres HTML-formular og styling og sæt det op i jeres Node.js/Express-projekt  
    \- Hvordan gør vi det med EJS?   
    \- Og hvad med styling?
...
6.  **Tilfældig svargenerering:**  
    \- Brug `Math.random()` til at vælge et svar fra et array    
    \- Gør chatbotten mere naturlig og uforudsigelig
    
7.  **Hands-on:**  
    \- Byg en chatbot, der matcher nøgleord og kan give flere forskellige svar    
